...
interface HeroSectionCareersProps {
...
const TRANSLATIONS: Record<string, {
  ...
  de: { // Deutsch (Germany)
    ...
    buttonContactUs: "In Kontakt treten",
  },
  es: { // Español (Spain)
    titlePart1: "MADE IN GERMANY ©",
    ...
    buttonContactUs: "Póngase en contacto",
  },
  fr: { // Français (France)
    titlePart1: "MADE IN GERMANY ©",
    ...
    buttonContactUs: "Prenez contact",
  },
  it: { // Italiano (Italy)
    titlePart1: "MADE IN GERMANY ©",
    ...
    buttonContactUs: "Mettiti in contatto",
  },
...
const HeroSectionCareers: React.FC<HeroSectionCareersProps> = ({ language = 'en' }) => {
  ...
  return (
    ...
    <section className="relative min-h-[25vh] w-full flex items-center justify-center overflow-hidden bg-black px-4 sm:px-6 md:px-8 lg:px-12">
      ...
      <div className="absolute inset-0">
        <div className="w-full h-full bg-[url('/made-in-germany-career.webp')] bg-cover bg-center animate-zoom" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto text-center sm:text-left text-white space-y-6 py-16 sm:py-20 lg:py-24">
        <div className="max-w-3xl mx-auto sm:mx-0 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-3 sm:gap-6">
            ...
            >
              {TRANSLATIONS[language]?.buttonContactUs || "Get in Touch"}
            </button>
          </div>
        </div>
      </div>
