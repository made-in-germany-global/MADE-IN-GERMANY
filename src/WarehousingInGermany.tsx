...
import WarehousinginGermany from './components/WarehousingInGermany';
...
const WarehousingInGermany: React.FC<ValuesProps> = ({ language = 'en' }) => {
...
export default WarehousingInGermany;